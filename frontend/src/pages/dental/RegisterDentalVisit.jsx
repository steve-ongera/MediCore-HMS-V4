  ...
  if (loading) {
    return (
      <div className="loading-screen">
        ...
        <span className="loading-screen__label">Loading dentists...</span>
      </div>
    );
  }
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <h1 className="page-title">Register Dental Visit</h1>
          <p className="page-subtitle">Start a new dental consultation</p>
        </div>
      ...
      <div className="card">
        <div className="card-header">
          <h5 className="card-title">
            <i className="bi bi-clipboard-plus  me-1"></i> Step 2: Visit Details
          </h5>
        </div>
        <div className="card-body">
          <form onSubmit={handleSubmit}>
            <div className="field">
              <label className="field-label">Dentist</label>
              <select className="select" value={selectedDentist} onChange={(e) => setSelectedDentist(e.target.value)}>
